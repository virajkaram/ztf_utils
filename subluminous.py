...
def is_subluminous(photometry,dm=None,flux=False):
    ...
    if dm==None: #or np.isnan(dm):
        return False, data[:,0][np.argmin(data[:,1])], -99
...
if __name__ == '__main__':
    ...
    parser.add_argument("--o",type=str,default='subluminous',help="output file to write results in")
